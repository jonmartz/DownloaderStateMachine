...
public class Movie {
    ...
    public void startDownload()
    {
        ...
        double sizeRemaning = (1-downloadProgress)*size;
        double timeRemaining = sizeRemaning/downloadSpeed;
        this.downloader = new TimeEvent(Context.getInstance(),2,timeRemaining);
